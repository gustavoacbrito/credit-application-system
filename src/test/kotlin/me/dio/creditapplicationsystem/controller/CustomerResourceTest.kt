...
class CustomerResourceTest {
  ...
  fun `should create a customer and return 201 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Brito"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678910"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("eu@email.com"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("00000-000"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua que eu moro, 123"))
  ...
  fun `should update a customer and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.status().isOk)
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("GustUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("BritoUp"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678910"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("eu@email.com"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("5000.0"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("85697-852"))
